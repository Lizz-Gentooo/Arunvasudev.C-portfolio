...
import { FiPhone, FiLinkedin, FiSend, FiCheck } from "react-icons/fi";
    ...
    <section id="contact" className="relative py-28 sm:py-36">
      <div className="container-shell">
        <Reveal>
          ...
          <h2 className="section-heading mb-14 max-w-2xl">Let's talk.</h2>
        </Reveal>

        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <Reveal direction="right" className="space-y-4">
            <p className="font-body text-day-secondary dark:text-space-white/60 max-w-sm">
              Open to internships and conversations about aerospace design and mechanical
              systems. Reach out directly below.
            </p>
              ...
              {contactLinks.map((link) => {
                ...
                return (
                  <a
                    ...
                    className="group flex items-center gap-4 rounded-xl border border-space-accent/15 bg-white/50 px-5 py-4 transition-all hover:border-space-accent/40 hover:-translate-y-0.5 dark:bg-space-secondary/30"
                  >
          ...
          <Reveal delay={0.1}>
            ...
            >
              ...
              >
                {submitted ? (
                  <>
                    <FiCheck size={16} /> Message logged
                  </>
                ) : (
                  <>
              ...
              <p className="text-center font-mono text-[11px] text-day-secondary/70 dark:text-space-white/30">
                This form is a UI preview — please use phone or LinkedIn above for a direct
                reply.
              </p>
            </form>
          </Reveal>
