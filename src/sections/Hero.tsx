...
export default function Hero() {
  return (
    ...
    >
      <div className="container-shell grid items-center gap-16 lg:grid-cols-[1.1fr_0.9fr]">
        <motion.div
          variants={container}
          initial="hidden"
          animate="show"
        ...
        >
          <div className="relative mx-auto h-72 w-72 sm:h-80 sm:w-80 lg:h-96 lg:w-96">
            {/* Orbit rings */}
            <div className="absolute inset-[-18px] rounded-full border border-space-accent/25 animate-orbit-slow" />
            <div className="absolute inset-[-38px] rounded-full border border-dashed border-space-accent/15 animate-orbit-reverse" />
            <span className="absolute -right-1 top-6 h-2 w-2 rounded-full bg-space-highlight shadow-[0_0_12px_rgba(125,211,252,0.8)] animate-orbit-slow" />
